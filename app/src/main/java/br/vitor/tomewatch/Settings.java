...
public final class Settings {
    ...
    public static final String K_MAP_SHAKE = "map_shake";  // action for the air shake gesture
    public static final String K_MAP_TWIST = "map_twist";  // action for the hand twist (rotate)
